...
sudo -u ec2-user bash -c "source /home/ec2-user/dr-env.sh && source \$HOME/.nvm/nvm.sh && cd \$HOME/megaticket/apps/app && AWS_REGION=${aws_region} PORT=3001 pm2 start npm --name 'app-backend' -- start"
