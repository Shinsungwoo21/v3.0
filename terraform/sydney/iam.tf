# =============================================================================
# IAM Roles and Policies - Sydney DR Region (V3.0)
# =============================================================================

# -----------------------------------------------------------------------------
# EC2 IAM Role (SSM + DynamoDB + Bedrock + CloudWatch + S3)
# -----------------------------------------------------------------------------
...
resource "aws_iam_role_policy" "s3_artifact_policy" {
  name = "${var.project_name}-pol-${var.region_code}-s3-artifact"
...
resource "aws_iam_role_policy" "dynamodb_policy" {
  name = "${var.project_name}-pol-${var.region_code}-dynamodb"
  role = aws_iam_role.ec2_role.id
...
resource "aws_iam_role_policy" "cloudwatch_policy" {
  name = "${var.project_name}-pol-${var.region_code}-cloudwatch"
  role = aws_iam_role.ec2_role.id
